...
\begin{figure}[!t]
    \centering
    \includegraphics[width=.8\textwidth]{ch3/assets/slp_model.jpg}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=.6\textwidth]{ch3/assets/non_contextual_nlidb.jpg}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=.7\textwidth]{ch3/assets/contextual_nlidb.jpg}
