...
\keywords{Inteligência Artificial, \textit{Text Mining}, Processamento de Linguagem Natural, \textit{Manufacturing Execution System}, \textit{Querying}} % Please define up to 6 keywords that better describe your work, print it elsewhere with \keywordnames
