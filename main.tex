...
\supervisor{Doutor Paulo Gandra da Sousa} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\input{pre-thesis/pre-thesis.tex}
%\input{ch1/chapter1}
%\input{ch2/chapter2}
%\input{ch3/chapter3}
%\input{ch4/chapter4}
